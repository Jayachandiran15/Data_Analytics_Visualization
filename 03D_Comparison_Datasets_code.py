# 3D) Comparison of Analysis Results Between UCI and Pima Diabetes Datasets
...
uci_r2 = 0.78       # Example R^2 score from Multiple Regression
pima_r2 = 0.72       # Example R^2 score from Multiple Regression
uci_accuracy = 82.4  # Example Logistic Regression Accuracy
pima_accuracy = 79.1 # Example Logistic Regression Accuracy

print(f"\nLinear Regression R^2 Scores: UCI - {uci_r2}, Pima - {pima_r2}")
